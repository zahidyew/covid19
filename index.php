...
$activeCases = $totalCases - $totalRecovered - $totalDeath; */
?>
               ...
               <table class="table table-bordered table-striped mb-none" id="datatable-default">
                  ...
                  <tbody>
                     ...
                     while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        $populationInfected = $totalCases / $population * 100;

                        if ($num > 1) {
                           $differences = $activeCases[$num - 1] - $activeCases[$num - 2];
                           ($newCases[$num - 2] != 0 ? $growthFactor = $newCases[$num - 1] / $newCases[$num - 2] :  $growthFactor = "NaN");
                        }
                        ...
                        echo '<td>' . round($populationInfected, 6) . '%</td>';
                        echo '<td>' . (is_float($growthFactor) ? round($growthFactor, 3) : $growthFactor) . '</td>';
                        echo '</tr>';
                        $num++;
                     }
                     ?>
